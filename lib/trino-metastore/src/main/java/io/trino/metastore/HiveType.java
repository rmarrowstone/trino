...
import static io.trino.metastore.type.TypeConstants.VOID_TYPE_NAME;
...
public final class HiveType
{
    ...
    public static final HiveType HIVE_VOID = new HiveType(getPrimitiveTypeInfo(VOID_TYPE_NAME));
